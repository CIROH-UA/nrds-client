...
export async function reclaimLegacyOpfsCache() {
  ...
  try {
    ...
    if (!root) return 0;
    // Recursive, because the directory holds .partial and .crswap leftovers as well as files.
    ...
    // NotFoundError is the ordinary case: most visitors never ran the build that wrote it.
